...
from .postprocess import yolo3_head
...
def yolo3_loss(args, anchors, num_classes, ignore_thresh=.5, label_smoothing=0, use_focal_loss=False, use_focal_obj_loss=True, use_softmax_loss=False, use_giou_loss=False, use_diou_loss=True):
    '''
